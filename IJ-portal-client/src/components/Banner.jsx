...
const Banner = ({query, handleInputChange}) => {
  ...
  return (
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14'>
        <h1 className='text-5xl font-bold text-primary mb-3'>Find a <span className='text-blue'> job </span> 
        or get your <span className='text-blue'> intership </span> today</h1>
        <p className='text-lg text-black/70 mb-8'> From start to finish, we will guide you to the 
        perfect work experience you are searching for.</p>
